...
def _fast_bin(grid, mlat, mlon,
    ...
    According to Kalle (author), the grid object passed to this function needs
    to be made by the sdarngrid function above.

    MLT keyword refer to the mlon argument only, since the sdarngrid function
    return the longitude in degrees.

    Locations below the defined grid are set to -1 in the returned array.
